...
json_file = open('../model/modelV4.json', 'r')
loaded_model_json = json_file.read()
json_file.close()

modelVGG = model_from_json(loaded_model_json)
modelVGG.load_weights('../model/HandSLTModelV4.h5')
...
def drawPredMobileNet(left, top, right, bottom):
    ...
    if bottom > top and right > left:
        ...
        if roi.shape[0] > 0 and roi.shape[1] > 0:  
          ...
          predictions = modelVGG.predict(img)
...
inputvideo = "../video/aus1.mov"
outputFile = "../video/out_aus1.mp4"
...
while (cap.isOpened()):
    ...
    outs = darknet.detect_image(netMain, metaMain, darknet_image, thresh=0.5)
